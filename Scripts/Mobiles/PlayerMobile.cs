	...
	public partial class PlayerMobile : Mobile, IHonorTarget
	{
		...
		*/
		...
		private static void OnLogin(LoginEventArgs e)
		{
            ...
            //should be handled in the loginstats
		    //var account = (Account)((PlayerMobile) from).Account;
		    //var lastStipend = account.Tags.FirstOrDefault(x => x.Name == "lastStipend");
		    //var doy = $"{DateTime.Now.DayOfYear}";
		    //if (lastStipend == null)
		    //{
      //          lastStipend = new AccountTag("lastStipend",doy);
      //          account.Tags.Add(lastStipend);
		    //}

		    //if (lastStipend.Value != doy)
		    //{
      //          from.SendMessage("You have earned a 500 gold stipend for logging in today.");
		    //    account.DepositGold(500);
		    //    lastStipend.Value = doy;
		    //}
		}
