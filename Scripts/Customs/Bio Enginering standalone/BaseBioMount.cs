...
namespace Server.Mobiles
{
	...
	[CorpseName( "a corpse" )]
	public class BaseBioMount : BaseMount
	{
		...
		[Constructable]
        public BaseBioMount()
            : base("A Bio Mount", 606, 0x3E90, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.1, 0.2)
		{
		...
		{
			if ( this.BodyValue == 605 || this.BodyValue == 606 )
			{
		...
		public override bool OnDragDrop( Mobile from, Item item )
		{
			...
			if ( this.BodyValue == 605 || this.BodyValue == 606 && from == this.ControlMaster )
			{
		...
		public override void AddNameProperties( ObjectPropertyList list )
		{
			...
			if ( m_Craftedby != null )
				list.Add( 1060658, "Servant Of\t{0}", m_Craftedby.Name.ToString() );
		}
		...
		public override void OnSpeech(SpeechEventArgs e)
		{
			...
			if ( e.Speech.ToLower().IndexOf( "morph" ) > -1 )
			{
				...
				if ( m == this.ControlMaster )
				{
					if ( this.BodyValue == 605 || this.BodyValue == 606 || this.BodyValue == 469 || this.BodyValue == 447 )
					{
						if ( this.BodyValue == 605 )
						{
							if ( this.Mounted == true )
							{
								IMount mount = this.Mount;
		...
		public void DoCure()
		{
			if ( this.BodyValue == 605 || this.BodyValue == 606 && this.Backpack != null )
			{
		...
		public BaseBioMount( Serial serial ) : base( serial )
		{
		}
