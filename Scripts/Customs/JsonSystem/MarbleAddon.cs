    ...
    public class MarbleAddon : BaseAddon
    {
        ...
        public void LoadTilePack()
        {
            ...
            switch (_tilePack)
            {
                ...
                case TilePackType.HeavyStone:                 set = new [] {466,467,464,465,468,463,491,489,490,488,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
                ...
                case TilePackType.OrnateSandBlock:      set = new [] {347,348,345,346,349,344,359,357,358,356,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
                ...
                case TilePackType.PlainWhiteMarble:            set = new [] {263,264,261,262,265,260,282,280,281,279,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
                case TilePackType.TrimmedWhiteMarble:           set = new [] {257,258,255,256,259,254,282,280,281,279,1208,1877,1879,1880,1878,1875,1873,1876,1874,1872}; break;
                case TilePackType.OrnateWhiteMarble:                set = new [] {251,252,249,250,253,248,273,271,272,270,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
                case TilePackType.LightHeavyStone:          set = new [] {204,202,200,201,203,199,223,222,221,220,1208,1877,1879,1880,1878,1875,1873,1876,1874,1872}; break;
                case TilePackType.LightWoodBanded:         set = new [] {177,188,175,176,187,174,192,191,190,189,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
                ...
                case TilePackType.StoneBlock:         set = new [] {90,94,88,87,93,89,108,105,106,107,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
                case TilePackType.Stone:          set = new [] {29,34,28,27,35,26,48,47,46,45,1208,1877,1879,1880,1878,1875,1873,1876,1874,1872}; break;
                case TilePackType.DarkWood:                set = new [] {9,14,7,8,15,6,23,22,21,20,1301,1853,1855,1856,1854,1851,1849,1852,1850,1848}; break;
