...
//		// YOUR SERVERS NAME
//		// ==================================================================================
//        public const string ServerName = "Blurropia";    // Server Name Goes Here
//	    public const string ServerNameA = "Phoenyx";  // Other Sever Name Goes Here
//	    public const string ServerNameB = "Blurropia-Deco";  // Other Sever Name Goes Here
//	    public const string ServerNameC = "Blurropia-Dev";  // Other Sever Name Goes Here
...
//        public static string Address = "blurropia.com";         // Server Address Goes Here
//        public static string AddressA = "phoenyx.blurropia.com"; 
//	    public static string AddressB = "deco.blurropia.com";         // Server Address Goes Here
//	    public static string AddressC = "dev.blurropia.com";         // Server Address Goes Here
        
//	    public const int Port = 2593;     //Only one port listing.....????
//        public const int PortA = 2595;     //Only one port listing.....????
//	    public const int PortB = 2594;     //Only one port listing.....????
//	    public const int PortC = 2596;     //Only one port listing.....????
//		// ==================================================================================
...
//                    e.AddServer(ServerNameA, new IPEndPoint(ipAddr, PortA)); //* changed 800 to PortA
//				    e.AddServer(ServerNameB, new IPEndPoint(ipAddr, PortB)); //* changed 800 to PortA
//				    e.AddServer(ServerNameC, new IPEndPoint(ipAddr, PortC)); //* changed 800 to PortA
//				} else {
//					e.Rejected = true;
//				}
//			}
...
//                }*/
//                state.Send(new CharacterList(state.Account, state.CityInfo,false));
//                return;
//            }
//            state.Dispose();
//        }
