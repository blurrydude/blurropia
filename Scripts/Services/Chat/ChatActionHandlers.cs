...
namespace Server.Engines.Chat
{
    public class ChatActionHandlers
    {
        ...
        public static void ChannelMessage(ChatUser from, Channel channel, string param, bool pending)
        {
            channel.SendMessage(57, from, from.GetColorCharacter() + from.Username,
        ...
        public static void LeaveChannel(ChatUser from, Channel channel, string param, bool pending)
        {
            channel.RemoveUser(from);
        }

        public static void JoinChannel(ChatUser from, Channel channel, string param, bool pending)
        {
            string name;
        ...
        public static void CreateChannel(ChatUser from, Channel channel, string param, bool pending)
        {
