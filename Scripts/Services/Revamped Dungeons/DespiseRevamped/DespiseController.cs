...
namespace Server.Engines.Despise
{
    public class DespiseController : Item
    {
        ...
        {
            //ConsoleUtility.Output("Locating Despise Revamp Spawners...");
            ...
            //ConsoleUtility.OutputLine("Located {0} Evil spawners, and {1} Good Spawners", m_EvilSpawners.Count, m_GoodSpawners.Count);
        }
